                                ...
                                <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    foreach ($rows as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?= $row->nilai ?></td>
                                            <td>
                                                <a class="btn btn-xs btn-warning" href="<?= site_url("backend/crips/ubah/$row->kode_crips") ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                <a class="btn btn-xs btn-danger " href="<?= site_url("backend/crips/hapus/$row->kode_crips") ?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
                                            ...
                                            <div class="col-md-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <a class="btn btn-default" href="<?= site_url('backend/crips/tambah') ?>"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                                                    </div>
                                                    <div class="form-group">
