                    ...
                    <?php if ($this->session->userdata('access') == '1') : ?>
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-pencil"></span>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="<?php echo site_url('backend/relasi'); ?>">Nilai Alternatif</a></li>
                            </ul>
                        </li>
                                ...
                                <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    <?php foreach ($alternatif as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <?php endforeach ?>
                                            <td>
                                                <a class="btn btn-xs btn-warning" href="<?= site_url("backend/relasi/ubah/$key") ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
