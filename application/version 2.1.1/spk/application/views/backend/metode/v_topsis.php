                ...
                <ul class="menu accordion-menu">
                    ...
                    <?php if ($this->session->userdata('access') == '1') : ?>
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-stats"></span>
                            ...
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('backend/hitung/topsis'); ?>">TOPSIS</a></li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                ...
                                <a class="btn btn-default" href="<?= site_url('backend/hitung/topsis_cetak') ?>" target="_blank"><span class="glyphicon glyphicon-print"></span> Cetak</a>
                            </div>
                        </div>
                    </div>
                </div><!-- Row -->
