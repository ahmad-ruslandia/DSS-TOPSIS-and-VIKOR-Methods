                                ...
                                <div class="panel-body">
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="kode" value="<?= set_value('kode', $rowl->kode_kriteria) ?>" readonly="" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nama Kriteria</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="nama" value="<?= set_value('nama', $rowl->nama_kriteria) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
