                ...
                <ul class="menu accordion-menu">
                    ...
                    <?php if ($this->session->userdata('access') == '1') : ?>
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-pushpin"></span>
                            ...
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('backend/kriteria'); ?>">Kriteria</a></li>
                                ...
                                <table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    foreach ($rows as $row) : ?>
                                        <tr>
                                            ...
                                            <td><?= $row->bobot ?></td>
                                            <td>
                                                <a class="btn btn-xs btn-warning" href="<?= site_url("backend/kriteria/ubah/$row->kode_kriteria") ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                <a class="btn btn-xs btn-danger" href="<?= site_url("backend/kriteria/hapus/$row->kode_kriteria") ?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
                                            ...
                                            <div class="col-md-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <a class="btn btn-default" href="<?= site_url('backend/kriteria/tambah') ?>"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                                                    </div>
                                                    <div class="form-group">
                                                        <a class="btn btn-default" target="_blank" href="<?= site_url('backend/kriteria/cetak?search=' . $this->input->get('search')) ?>"><span class="glyphicon glyphicon-print"></span> Cetak</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
