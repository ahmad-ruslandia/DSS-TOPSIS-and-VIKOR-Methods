                                ...
                                <div class="panel-body">
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="kode_alternatif" value="<?= set_value('kode', $rowl->kode_alternatif) ?>" readonly="" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nama Alternatif</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="nama_alternatif" value="<?= set_value('nama_alternatif', $rowl->nama_alternatif) ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
